...
arg_lists: List[argparse._ArgumentGroup] = []
parser = argparse.ArgumentParser(description="RAM")

def str2bool(v: str) -> bool:
    return v.lower() in ("true", "1")

def add_argument_group(name: str) -> argparse._ArgumentGroup:
...
glimpse_arg.add_argument("--glimpse_scale", type=int, default=1, help="Scale of successive patches")
...
core_arg.add_argument("--num_glimpses", type=int, default=6, help="# of glimpses, i.e. BPTT iterations")
...
reinforce_arg.add_argument("--std", type=float, default=0.05, help="Gaussian policy standard deviation")
reinforce_arg.add_argument("--M", type=int, default=1, help="Monte Carlo sampling for valid and test sets")
...
data_arg.add_argument("--shuffle", type=str2bool, default=True, help="Whether to shuffle the train and valid indices")
data_arg.add_argument("--show_sample", type=str2bool, default=False, help="Whether to visualize a sample grid of the data")
...
train_arg.add_argument("--init_lr", type=float, default=3e-4, help="Initial learning rate value")
train_arg.add_argument("--lr_patience", type=int, default=20, help="Number of epochs to wait before reducing lr")
...
misc_arg.add_argument("--ckpt_dir", type=str, default="/usr/users/vhassle/curiosity/recurrent-visual-attention/ckpt", help="Directory in which to save model checkpoints")
misc_arg.add_argument("--logs_dir", type=str, default="./logs/", help="Directory in which Weights and Biases logs will be stored")
